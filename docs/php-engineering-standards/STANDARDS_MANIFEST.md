...
`3de026f86f68c548c8eef1570a6aac0e3949f20a`
...
```text
docs/php-engineering-standards/standards/packages/PACKAGE_BUILDING_STANDARD.md                  version 3.0.0
docs/php-engineering-standards/standards/packages/COMPOSER_PACKAGE_STANDARD.md                 version 3.0.1
docs/php-engineering-standards/standards/packages/CI_WORKFLOW_STANDARD.md                      version 2.0.0
docs/php-engineering-standards/standards/packages/LIBRARY_PRESENTATION_STANDARD.md             version 2.0.1
docs/php-engineering-standards/standards/testing/TESTING_STANDARD.md                           version 1.1.1
docs/php-engineering-standards/standards/ai/AI_COLLABORATION_WORKFLOW_AR.md                    version 7.0.1
docs/php-engineering-standards/standards/GITHUB_PHASE_STACK_WORKFLOW_AR.md                     version 3.0.1
docs/php-engineering-standards/standards/governance/DOCUMENTATION_LIFECYCLE_STANDARD_AR.md    version 2.0.0
```

- Standards الناتجة عن `composer-package`: `PACKAGE_BUILDING_STANDARD.md` (3.0.0)، `COMPOSER_PACKAGE_STANDARD.md` (3.0.1)، `CI_WORKFLOW_STANDARD.md` (2.0.0)، `LIBRARY_PRESENTATION_STANDARD.md` (2.0.1)، `TESTING_STANDARD.md` (1.1.1)، `DOCUMENTATION_LIFECYCLE_STANDARD_AR.md` (2.0.0).
- Standards الناتجة عن `repository-governance`: `AI_COLLABORATION_WORKFLOW_AR.md` (7.0.1)، `GITHUB_PHASE_STACK_WORKFLOW_AR.md` (3.0.1)، `DOCUMENTATION_LIFECYCLE_STANDARD_AR.md` (2.0.0).
