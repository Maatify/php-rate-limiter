...
- **Artifact Facts:** Repository جديد لمكتبة PHP مستقلة؛ Composer identity المستهدفة `maatify/php-rate-limiter`؛ Standalone reusable Composer package؛ Scope للحوكمة هو repository root `/`.
...
docs/php-engineering-standards/standards/ai/AI_COLLABORATION_WORKFLOW_AR.md          version 6.0.0
