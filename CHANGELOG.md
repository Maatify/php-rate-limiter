...
- Clarified the locked Budget Owner-Safety architecture (Spec Version remains `1.1.0`):
  ...
  and Anti-Equilibrium records only the final issued `SOFT_BLOCK`.
